import { ComponentConfig, type Slot } from "@puckeditor/core";
...
/** Render a slot prop safely: a render component in Puck, a placeholder elsewhere. */
function renderSlot(slot: Slot, label: string) {
  const C = slot as unknown;
