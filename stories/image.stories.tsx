...
import { ImageBlock, type ImageProps } from "../components/image";
...
const meta = {
  ...
  tags: ["autodocs"],
  argTypes: {
    width: { control: "radio", options: ["contained", "full"] },
    ...
    treatment: { control: "radio", options: ["color", "bw"] },
  },
...
export const Contained: Story = { args: { ...base } };
export const BlackAndWhite: Story = { args: { ...base, treatment: "bw" } };
